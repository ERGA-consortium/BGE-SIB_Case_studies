...
angsd  -i ${sample} -ref $ref -sites ${dir}Species_pop_filter*.list -anc $ref -out ${dir}${name}_filtList_pop -uniqueOnly 1 -remove_bads 1 -only_proper_pairs 1 -setMinDepth 4 -noTrans $trans -C 50 -baq $baq -minMapQ 30 -minQ 20 -setMaxDepth 50 -doCounts 1 -nThreads 10 -GL 2 -doSaf 1 -rf $scaffolds
