# ArnicaSNP – establishing a baseline for genomic monitoring of Arnica montana in Europe
This repository includes all the scripts used to process raw data, genotype samples and run data analyses within our project.
...
Additional financial support came from Freie Universität Berlin and the Friends of the Botanic Garden and Botanical Museum Berlin-Dahlem Association.

We warmly thank our collaboration partners for this project:
- Elke ZIPPEL and Thomas BORSCH, BO Berlin/Freie Universität Berlin, Germany
- Manuel VERA, University of Santiago de Compostela, Spain
