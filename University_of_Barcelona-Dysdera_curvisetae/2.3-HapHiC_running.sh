...
#   11 --quick_view           : HapHiC will ignore the parameter `nchrs`, it can be any integer
...
/users-d1/silvia.garcia/Programs/HapHiC/haphic pipeline ../$1 ../HiC_$1_filtered.bam 11 --quick_view --RE "GATC,TTAA" --correct_nrounds 2
